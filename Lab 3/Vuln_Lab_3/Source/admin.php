...
<div style="max-width: 600px; margin: auto; padding: 30px; background: #f9f9f9; border-radius: 10px; box-shadow: 0 0 8px rgba(0,0,0,0.1);">
    ...
    <p>You have successfully completed all steps of this FakeBook lab. Please make sure that you already done all of following step:</p>
    <ul>
    ...
    <p>If you are missing any above one, please go back and finish it correctly to deserve this flag.</p>
